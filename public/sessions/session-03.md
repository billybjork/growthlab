...
### **Sharpen your skills in Flora**

<!-- block -->

<div class="callout">### **🎯 Goal:**

Create the **"production" version** of an asset you prototyped in Assignment #2 (based on a creative reference for BarkBox).
...
3. **Spend >60 min** building and experimenting in Flora
4. **Create at least >5 variations** (using different model/prompt combinations)

<!-- block -->

<div class="callout">### **📊 Design Criteria:**

Consider how you can improve on the prototype:
- Does it feel "on brand" for BarkBox?
- Is it visually polished and production-ready?
- Does it effectively communicate the intended message?</div>
...
<!-- row -->
<div class="callout">1. 🔍 The **original reference** you found for BarkBox (Assignment #1), and why you think it's relevant/applicable
2. 🚢 Your **"rapid prototype"** based on that reference (Assignment #2)
3. 🎬 Your **"production" version** of the asset, created in Flora (Assignment #3)
4. 🖥️ Your **Flora canvas** used to produce this asset</div>
<!-- col -->
[Image: Assignment progression visual - reference → prototype → production]
<!-- /row -->
...
<!-- row -->
[Video: Introduction to FLORA Basics]
<!-- col -->
[Video: How this short film was made in FLORA]
<!-- /row -->
---
## 📝 Submit Assignment #3
...
<div data-form="assignment-3">
  ...
  <input type="text" id="original_ref" name="original_ref" required />

  <label for="ref_rationale">Why is this reference relevant/applicable to BarkBox?</label>
  <textarea id="ref_rationale" name="ref_rationale" rows="3" required></textarea>

  <label for="prototype_url">Your Rapid Prototype from Assignment #2 (GDrive URL):</label>
  <input type="text" id="prototype_url" name="prototype_url" required />
  ...
  <label for="production_url">Your Production Asset from Flora (GDrive URL):</label>
  <input type="text" id="production_url" name="production_url" required />

  <label for="flora_canvas">Link to your Flora Canvas/Project:</label>
  <input type="text" id="flora_canvas" name="flora_canvas" required />
  ...
  <textarea id="learnings" name="learnings" rows="3" required></textarea>
...
<!-- col -->
[Image: Recap visual - node workflow diagram]
<!-- /row -->
