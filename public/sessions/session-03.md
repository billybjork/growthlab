...
Sharpen your skills in Flora by creating the **"production" version** of a BarkBox asset you prototyped in Assignment #2.
...
5. In our next session, come prepared to share:
   ...
   - Your **"production" version** of the asset, and the Flora canvas you used to create it (Assignment #3)
...
***
  ...
  <label for="production_url">Your "Mini Capstone" asset improving on the prototype:</label>
  <input type="text" id="production_url" name="production_url" required placeholder="Google Drive URL" />
