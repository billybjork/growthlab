...
<!-- row -->
<div class="callout">1. Choose **one creative reference** from Assignment #1 to share into our Slack channel
...
- ✍️ **Text-to-image** – Generate an image from a text prompt
...
- 🖌️ **Inpainting** – Fill in or change content inside a selected region of an image
- ↔️ **Outpainting** – Extend an image beyond its borders while matching the original style (aka "uncropping")
...
- 🎞️ **Image-to-video** – Animate a still image using text or motion prompts
- ⏯️ **Frame interpolation** – Generate "in-between" frames
