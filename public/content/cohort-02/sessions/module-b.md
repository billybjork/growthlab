...
<div class="callout">### **Key Concepts to Note:**
- How to create and connect nodes
- Using text nodes for prompts
- Image generation and iteration
- Comparing outputs from different models
- Exporting your final assets</div>
...
<div data-form="assignment-c2-02">
...
***
  <label for="flora_project">Link to your Flora Project:</label>
...
3. **Be prepared to share** at least one observation in Live Session 2
...
<div data-form="assignment-c2-03">
  <label for="email">Email:</label>
  <input type="email" id="email" name="email" required placeholder="Use your @growthassistant.com email" />
