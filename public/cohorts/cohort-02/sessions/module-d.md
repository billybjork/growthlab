...
In this module, you'll build two key deliverables:
...
**Quick math:** 1 token ≈ ¾ of a word (so 5,000 tokens ≈ 3,750 words).
...
<div style="text-align: center">### *"How does this product, audience, and category actually show up in the wild?"*</div>
...
<div style="text-align: center">Use a mix of **web search**, **social/community platforms**, and **reviews**.

You can use AI tools to help summarize, but you're still the editor.</div>
...
<div style="text-align: center">#### Now, turn your notes into a **clean, usable document**.</div>
...
2. **Fill in each section** – Tight bullets and short paragraphs (clear, concrete statements > jargon).
...
### **Upload your system prompt and concept briefs**

<!-- block -->

<div data-form="assignment-c2-05">
...
***
  <label for="concept_1_name">Concept Brief #1 – Name:</label>
  <input type="text" id="concept_1_name" name="concept_1_name" required placeholder="e.g., 'First Step Courage'" />

  <label for="concept_1_brief">Concept Brief #1 – Full Brief:</label>
  <textarea id="concept_1_brief" name="concept_1_brief" rows="6" required placeholder="Include: Core Idea, Visual Direction, Target Emotion, Key Message, Why It Works, Potential Challenges"></textarea>
***
  <label for="concept_2_name">Concept Brief #2 – Name:</label>
  <input type="text" id="concept_2_name" name="concept_2_name" required placeholder="e.g., 'Everyday Wellness'" />

  <label for="concept_2_brief">Concept Brief #2 – Full Brief:</label>
  <textarea id="concept_2_brief" name="concept_2_brief" rows="6" required placeholder="Include: Core Idea, Visual Direction, Target Emotion, Key Message, Why It Works, Potential Challenges"></textarea>
***
  <label for="concept_3_name">Concept Brief #3 – Name (optional):</label>
  <input type="text" id="concept_3_name" name="concept_3_name" placeholder="Optional third concept" />

  <label for="concept_3_brief">Concept Brief #3 – Full Brief (optional):</label>
  <textarea id="concept_3_brief" name="concept_3_brief" rows="6" placeholder="Include: Core Idea, Visual Direction, Target Emotion, Key Message, Why It Works, Potential Challenges"></textarea>
***
  <label for="reflections">Any reflections or open questions? (optional)</label>
  <textarea id="reflections" name="reflections" rows="3" placeholder="Anything you found interesting, confusing, or want to discuss in Live Session 3"></textarea>
***
