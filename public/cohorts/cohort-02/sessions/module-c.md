...
Before polishing your mini capstone, let's refresh the key feedback principles from Live Session 2.

<!-- block -->

<img src="media/shared/20251202_104720.webp" alt="" style="display: block; max-width: 700px; width: 700px; margin-left: auto; margin-right: auto">
...
### **Apply Your "Ruthless Editor" to Your Own Work:**

<!-- block -->

<!-- row -->
#### Qualities of Effective Self-Critique:

- **Specific** – pinpoint exactly what needs improvement
- **Actionable** – identify concrete steps to fix it
- **Grounded in goals** – evaluate against the intended purpose
- **Uses references** – compare against successful examples
<!-- col -->
#### Questions to Ask:
...
- Experiment with style/lighting adjustments
...
### **Submit your polished mini capstone asset**

<!-- block -->

<div data-form="assignment-c2-04">
  <label for="email">Email:</label>
  <input type="email" id="email" name="email" required placeholder="Use your @growthassistant.com email" />

***
  <label for="flora_project">Flora Project URL:</label>
  <input type="text" id="flora_project" name="flora_project" required placeholder="Share link to your Flora canvas" />

  <label for="before_screenshot">Before Screenshot (raw Flora export):</label>
  <input type="text" id="before_screenshot" name="before_screenshot" required placeholder="Google Drive URL" />

  <label for="after_screenshot">After Screenshot (finished in traditional tool):</label>
  <input type="text" id="after_screenshot" name="after_screenshot" required placeholder="Google Drive URL" />

  <label for="final_asset">Final Polished Asset:</label>
  <input type="text" id="final_asset" name="final_asset" required placeholder="Google Drive URL (high-res export)" />

***
  <label for="finishing_tool">Which traditional tool did you use for finishing?</label>
  <input type="text" id="finishing_tool" name="finishing_tool" required placeholder="Figma, Canva, Photoshop, etc." />

  <label for="improvements">What improvements did you make in traditional tools?</label>
  <textarea id="improvements" name="improvements" rows="3" required placeholder="Describe the finishing work you did"></textarea>

  <label for="self_critique">What would you improve further if you had more time?</label>
  <textarea id="self_critique" name="self_critique" rows="3" required placeholder="Apply your 'Ruthless Editor' - be honest!"></textarea>
***
...
### **Week 1 was about building foundations. Week 2 is about going deeper.**
...
### **The Key Difference in Week 2:**

Week 1 focused on **tool skills** – how to use AI tools effectively.
